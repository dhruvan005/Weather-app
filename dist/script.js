...
//         })
//         .catch(error => {
//             console.error(' Error in fatching Weather', error);
...
//         })
//         .catch(error => {
//             console.error(' Error in fatching forecast', error);
//             alert('Please try again');
//         });
...
//             <span>${hour}:00</span>
//             <img src="${iconUrl}" alt="Hourly Weather Icon" class=""text-white mt-3"> <span>${temperature} °C</span>
//             </div>`;
